...
exports.CheckEmailDocument = client_1.gql(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n    query checkEmail($email: String!) {\n  isEmailExists(email: $email)\n}\n    "], ["\n    query checkEmail($email: String!) {\n  isEmailExists(email: $email)\n}\n    "])));
...
exports.GetJoinedSubDocument = client_1.gql(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n    query getJoinedSub {\n  getJoinSub {\n    sub {\n      displayName\n      name\n      picture_url\n    }\n  }\n}\n    "], ["\n    query getJoinedSub {\n  getJoinSub {\n    sub {\n      displayName\n      name\n      picture_url\n    }\n  }\n}\n    "])));
...
exports.CreatePostWithMarkDownDocument = client_1.gql(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n    mutation createPostWithMarkDown($postData: PostInputMarkDown!) {\n  createPostWithMarkDown(postData: $postData) {\n    path\n    message\n  }\n}\n    "], ["\n    mutation createPostWithMarkDown($postData: PostInputMarkDown!) {\n  createPostWithMarkDown(postData: $postData) {\n    path\n    message\n  }\n}\n    "])));
...
exports.CreatePostWithLinkDocument = client_1.gql(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n    mutation createPostWithLink($postData: PostInputLink!) {\n  createPostWithLink(postData: $postData) {\n    path\n    message\n  }\n}\n    "], ["\n    mutation createPostWithLink($postData: PostInputLink!) {\n  createPostWithLink(postData: $postData) {\n    path\n    message\n  }\n}\n    "])));
...
exports.CreatePostWithImageDocument = client_1.gql(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n    mutation createPostWithImage($postData: PostInputImage!) {\n  createPostWithImage(postData: $postData) {\n    path\n    message\n  }\n}\n    "], ["\n    mutation createPostWithImage($postData: PostInputImage!) {\n  createPostWithImage(postData: $postData) {\n    path\n    message\n  }\n}\n    "])));
...
exports.AddVoteDocument = client_1.gql(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n    mutation addVote($voteData: Vote!) {\n  addVote(voteData: $voteData) {\n    message\n    path\n  }\n}\n    "], ["\n    mutation addVote($voteData: Vote!) {\n  addVote(voteData: $voteData) {\n    message\n    path\n  }\n}\n    "])));
...
exports.IsVotedDocument = client_1.gql(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n    query isVoted($post_id: String!) {\n  isVoted(post_id: $post_id)\n}\n    "], ["\n    query isVoted($post_id: String!) {\n  isVoted(post_id: $post_id)\n}\n    "])));
...
exports.RemoveVoteDocument = client_1.gql(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n    mutation removeVote($voteData: Vote!) {\n  removeVote(voteData: $voteData) {\n    message\n    path\n  }\n}\n    "], ["\n    mutation removeVote($voteData: Vote!) {\n  removeVote(voteData: $voteData) {\n    message\n    path\n  }\n}\n    "])));
